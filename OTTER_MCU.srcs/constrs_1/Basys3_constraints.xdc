...
##Pmod Header JA
##Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports {BTN_PMOD[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {BTN_PMOD[0]}]
##Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {BTN_PMOD[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {BTN_PMOD[1]}]
##Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports {BTN_PMOD[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {BTN_PMOD[2]}]
##Sch name = JA4
#set_property PACKAGE_PIN G2 [get_ports {BTN_PMOD[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {BTN_PMOD[3]}]
###Sch name = JA7
#set_property PACKAGE_PIN H1 [get_ports {BTNC_PMOD}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {BTNC_PMOD}]
###Sch name = JA8
...
##Pmod Header JXADC
##Sch name = XA1_P
#set_property PACKAGE_PIN J3 [get_ports {JOY_X}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {JOY_X}]
##Sch name = XA2_P
#set_property PACKAGE_PIN L3 [get_ports {JOY_Y}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {JOY_Y}]
##Sch name = XA3_P
